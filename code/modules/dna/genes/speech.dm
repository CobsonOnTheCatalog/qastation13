...
#define GENERIC_INSULT_WORDS "\\b(asshole|condom|shitter|shitler|retard|dipshit|dipshit|greyshirt|cuck|security|shitcurity)"
...
/datum/speech_filter/chav/New()
	...
	addReplacement("condom","knob'ead")
	addReplacement("looking at","gawkin' at")
	...
	addReplacement("\\b(don't know|dunno)","don't bloody knaw")
	...
	addPickReplacement("fucking hell", list("bloody 'ell", "fooken 'ell"))
...
//Time for a friendly game of SS13
	...
	addWordReplacement("gay", "flamboyant")
	...
	addWordReplacement("ugly", "beautiful")
	addWordReplacement("douchebag", "nice guy")
	addWordReplacement("nerd","smart guy")
	addWordReplacement("moron","fun person")
	addWordReplacement("\\b(SINGULOOSE|SINGULO|PLASMAFLOOD|PLASMAFLUBB)", "PERFECTLY NORMAL STATION")
	addWordReplacement("IT'S \\b(ROGUE|ROUGE|LOOSE)", "EVERYTHING IS FINE")
	...
	addWordReplacement("\\b(feminist|foid|whore|slut)", "empowered woman")
	addReplacement("cuck", "simp")
	addPickReplacement("fag", list("fig", "friend"))
	addReplacement("\\b(tranny|troon)", "stunning and brave")
	addReplacement("\\b(trannies|troons)", "the stunning and brave")
	addWordReplacement("ack", "pass away")
	addWordReplacement("acked", "passed away")
	addReplacement("\\b(shit|crap)","poo")
	addReplacement("ass","butt")
	addPickReplacement("damn",list("darn","dang"))
	addReplacement("hell","heck")
	addReplacement("fuck", "cuddle")
	addWordReplacement("\\b(penis|cunt|vagina|cock|pecker|bbc|bwc|tbp|twp)", "privates")
	addReplacement("dick","jerk")
	addReplacement("tits","mammary glands") //now all the 7 dirty words are filtered
	addWordReplacement("\\b(oy|doctos)", "I'M FINE")
	addReplacement("nusoi", "newcomer")
	addWordReplacement("newfag", "newcomer")
	addWordReplacement("oldfag", "old-timer")
...
/datum/speech_filter/elvis/New()
	addWordReplacement("im not","I aint")
	addWordReplacement("i'm not","I ain't")
	addWordReplacement("youre not", "You aint")
	addWordReplacement("you're not", "You ain't") //YOU AIN'T NOTHING BUT A HOUND DOG, CRYING ALL THE TIME
...
/datum/speech_filter/luchador/New()
	...
	addWordReplacement("\\b(is|it's)", "es")
	addPickReplacement("was", list("fue", "era"))
	addWordReplacement("\\b(friend|buddy|mate)", "amigo")
	addPickReplacement("\\b(dude|bro|homie)", list("holmes", "wey", "mane"))
	...
	addWordReplacement("\\b(nukies|ops|nukeops|nuke ops)", "nucleares")
	addWordReplacement("or something", "o algo")
	addWordReplacement("\\b(foreigner|american)", "gringo")
	addWordReplacement("mexican", "hermano")
	addWordReplacement("oy", "OYE")
	addWordReplacement("doctos", "DOCTORES")
